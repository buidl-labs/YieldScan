		...
		<React.Fragment>
			...
			<VerticalTimeline layout="1-column" className="py-0">
				...
				>
					...
					<Text>
						On the Polkadot UI, go to the “Staking” tab. On the top-left of this
						section you’ll see a tab labelled “Account actions”. Click on this
						tab. Next, click on the button labelled “New stake” on your screen.
						This will open up a form with fields for your stash account,
						controller account, value to be bonded from the stash account and
						payment destination. In the stash and controller account fields,
						select your stash and controller accounts respectively. In the
						“value bonded” field, enter the amount of tokens that you would like
						to stake in forthcoming rounds. Lastly, for the “payment
						destination” select whichever payment destination you like. If
						you’re unsure just click “Stash account (increase amount at stake)”.
						Click on the “Bond” button. This will open up an authenication form,
						enter the password of your stash account and click “Sign and Submit”
						button. Now, you’re bonded and ready to nominate.
					</Text>
				</VerticalTimelineElement>
				...
				>
					...
					<Text>
						Go to the “Staking Overview” tab. You’ll see the list or current
						validators on the left side. On the right side, you’ll see a list of
						validators that have signalled their intention to actively
						participate in the next era. Pick one (or more) of these validators
						to nominate and copy their address by clicking on the icon. Return
						to the “Account Actions” screen and you will see your bonded
						account. Click the “Nominate” button and fill in the blank field
						with the address of the validator you have chosen. Sign and submit
						the transaction, and you are now nominating!
					</Text>
				</VerticalTimelineElement>
				...
				>
					...
					<Text>
						To stop nominating, click the “Stop nominating” button. If you want
						to start nominating again, just repeat step 4.
						<br />
