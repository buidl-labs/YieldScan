                ...
                this.setState({
                    ...
                    dailyEarning: (() => {
                        ...
                        const userStakeFraction =
                            1000 / (1000 + parseFloat(totalStaked))
                        const dailyEarning =
                            userStakeFraction * poolReward * ERA_PER_DAY
                    ...
                    <Media queries={{ small: '(max-width: 500px)' }}>
                        {matches =>
                            matches.small ? (
                                ...
                                >
                                    <Text>
                                        We're working on mobile support for
                                        specific views, we apologize for the
                                        inconvenience. You can view this page on
                                        a larger device.
                                    </Text>
                                </Box>
                            ) : (
                                    ...
                                    <Box textAlign="center">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <AlertDescription>
                                                    Click on the nominator
                                                    circles to open nominator's
                                                    specfic view data and
                                                    visualization
                                                </AlertDescription>
                                                <CloseButton
                                                    position="absolute"
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={e => {
                                                            ...
                                                            const dailyEarning =
                                                                userStakeFraction *
                                                                poolReward *
                                                                ERA_PER_DAY //if pool reward is zero then what ?
                                                            this.setState({
                                                                stakeInput: stakeAmount,
                                                                dailyEarning: dailyEarning.toFixed(
                                                                    3
                                                                ),
                                                            })
                                                        }}
