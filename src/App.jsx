                        ...
                        {isLoaded && apiConnected ? (
                            <React.Fragment>
                                ...
                                >
                                    <Text
                                        ...
                                        color="gray.500"
                                    >
                                        Stake amount (change input to see
                                        potential earnings)
                                    </Text>
                                    <InputGroup>
                                        <Input
                                ...
                                <Text textAlign="center" mt={8} mb={8}>
                                    Looking for a list of active validators to
                                    stake on? Look no further!
                                </Text>
                                <ValidatorTable
                            ...
                            >
                                ...
                                >
                                    ...
                                    <br />
                                    But this calculation will be done in a few
                                    minutes :)
                                </Text>
                            </Box>
                        )}
                        ...
                        if (!props.history.location.pathname.split('/')[3]) {
                            return (
                                ...
                                >
                                    ...
                                    >
                                        Oops! URL must include a validator's
                                        address
                                    </p>
                                </div>
                            )
                            ...
                            return isLoaded && apiConnected ? (
                                <ValidatorApp
                                    ...
                                    valtotalinfo={validatorData.map(
                                        data => data.stashId
                                    )}
